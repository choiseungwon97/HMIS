...
*/
   ...
   public void graduList(HttpServletRequest request, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
      ...
      model.addAttribute("userNo", userNo);
      System.out.println("====> service.graduListSearchCount(cri) : " + service.graduListSearchCount(cri));
      System.out.println("====> service.graduList(cri) : " + service.graduList(cri).get(0));
